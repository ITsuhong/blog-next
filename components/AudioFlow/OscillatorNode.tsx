...
export function OscillatorNode({ id, data }: OscillatorNodeProps) {
    ...
    return (
        <div className={'bg-audio-background shadow-xl text-black rounded-t-md overflow-hidden'}>
            <p className={'p-[8px] bg-pink-500 '}>振荡器节点</p>
            ...
            <div className={'flex flex-col p-[8px'}>
                <p>波形</p>
                <select value={type} onChange={changeType} className="text-white">
