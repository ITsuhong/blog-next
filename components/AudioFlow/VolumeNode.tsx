...
export function VolumeNode({ id, data }: VolumeNodeProps) {
    ...
    return (
        <div className={'rounded-md bg-audio-background shadow-xl text-black'}>
            <Handle type="target" className="w-[10px] h-[10px]" position={Position.Top} />

            <p className={'rounded-t-md p-[4px] bg-blue text-white'}>音量节点</p>
            <div className={'flex flex-col p-[4px]'}>
                <p>Gain</p>
                <input className="bg-blue" type="range" min="0" max="1" step="0.01" value={gain} onChange={changeGain} />
