        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger>
                <div className="mb-3">
                    ...
                    <div
                        className="relative cursor-pointer opacity-90 hover:opacity-100 transition-opacity p-[2px] bg-black rounded-[16px] bg-gradient-to-tr from-active to-cyan-400  active:scale-95"
                    >
  <span
      className="w-full h-full flex items-center gap-2 px-4 py-1 bg-primary text-white rounded-[14px] bg-gradient-to-tr from-primary to-cyan-400 "
  >
    <svg
